...
public class HW03Tests {
    ...
    public void testEraseThere() {
        ...
        assertEquals("PhotoLibrary.erasePhoto() failed (photo wasn't removed from the albums) (also check getAlbums())",
                new HashSet<Photograph>(), a.getPhotos());
        a = null;
        for (Album c : b.getAlbums()) {
    ...
    public void testGetPhotosYear() {
        ...
        assertTrue("PhotoLibrary getPhotos(rating) did not return correct photos of rating 0 or higher",
                a.getPhotos(0).contains(b));
        assertTrue("PhotoLibrary getPhotos(rating) did not return correct photos of rating 0 or higher",
                a.getPhotos(0).contains(c));
        assertTrue("PhotoLibrary getPhotos(rating) did not return correct photos of rating 0 or higher",
                a.getPhotos(0).contains(d));
    }
    ...
    public void testGetPhotosBetween2() {
        ...
        assertEquals("PhotoLibrary getPhotosInBetween() returned photos when dates not formatted correctly", null,
                a.getPhotosBetween("2016-12-33", "2017-01-02"));
        assertEquals("PhotoLibrary getPhotosInBetween() returned photos when dates not formatted correctly", null,
                a.getPhotosBetween("2016-15-11", "2017-01-02"));
        assertEquals("PhotoLibrary getPhotosInBetween() returned photos when dates not formatted correctly", null,
                a.getPhotosBetween("2016-10-11", "2017-21-02"));
        assertEquals("PhotoLibrary getPhotosInBetween() returned photos when dates not formatted correctly", null,
                a.getPhotosBetween("2016-10-11", "2017-02-34"));
    }
    ...
    public void removePhotoTest() {
        PhotoLibrary b = new PhotoLibrary("Testing", 42);
        Photograph c = new Photograph("winnie", "pooh");
        b.addPhoto(c);
        assertTrue(b.removePhoto(c));
    }

    @Test
    public void removePhotoTest2() {
        PhotoLibrary b = new PhotoLibrary("Testing", 42);
        Photograph d = new Photograph("winnieThePooh", "Oh bother");
        assertFalse(b.removePhoto(d));
    }
    ...
    public void compareToTest() {
        ...
        assertTrue((c.compareTo(d) == c.getCaption().compareTo(d.getCaption())));
    }

    @Test
    public void compareToTest2() {
        Photograph c = new Photograph("Pooh", "WinnieThePooh", "2000-04-20", 5);
        Photograph d = new Photograph("winnieThePooh", "Oh bother", "2000-04-21", 5);

        assertTrue((c.compareTo(d) == c.getDateTaken().compareTo(d.getDateTaken())));
    }
    ...
    public void compareByCaption() {
        ...
        assertTrue(photos.equals(photos2));
    }
    ...
    public void compareByCaption2() {
        ...
        ArrayList<Photograph> photos2 = new ArrayList<Photograph>(photos);
        Collections.sort(photos, new CompareByCaption());
